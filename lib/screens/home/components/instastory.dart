                        ...
                        ClipOval(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              image: (isStorySeen == true) ? DecorationImage(
                                image: AssetImage('assets/icons/stroke_seen_solid.png',
                                
                                ),
                              ) : (isAdmin == true) ?DecorationImage(
                                image: AssetImage('assets/icons/stroke_new_dash.png'),
                              ) : DecorationImage(
                                image: (isInstastory == true) ? AssetImage(
                                'assets/icons/stroke_on_solid.png',
                              ) : AssetImage(avatar,),
                              ),
                            ),
                            child: (isInstastory == true) ? Container(
                              decoration: BoxDecoration(
